function [X, obj, stats_proj, all_L, objs, opt_lambdas, time, lower_bound] = ...
    closest_seq_via_FBPG_new(A, rhs, m, p, max_iter, tol_subp, L0, tol, beta, gamma)
...
[X, obj, stats_proj, all_L, objs, opt_lambdas, time, lower_bound] = ...
    FBPG_new(A, X, X_grad_phi, X_val_phi, rhs, f_oracle, max_iter, tol_subp, tol, L0, beta, gamma);
end